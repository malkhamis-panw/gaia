...
func (o *FileAccessReport) GetSpread() int {

	return o.Spread
}

// SetSpread sets the property Spread of the receiver using the given value.
func (o *FileAccessReport) SetSpread(spread int) {
...
// GetSpread returns the Spread of the receiver.
func (o *SparseFileAccessReport) GetSpread() (out int) {
...
func (o *SparseFileAccessReport) SetSpread(spread int) {
