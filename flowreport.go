...
// GetSpread returns the Spread of the receiver.
func (o *SparseFlowReport) GetSpread() (out int) {
...
func (o *SparseFlowReport) SetSpread(spread int) {
