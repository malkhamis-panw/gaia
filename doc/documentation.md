...
Deletes the Prisma Cloud Alert Rule with a given id.

##### `GET /cloudalertsrule/:id`

Retrieves the Prisma Cloud Alert Rule with a given id.
...
Updates the Prisma Cloud Alert Rule with a given id.
...
The result object of executing policies in an alert rule.
...
##### `DELETE /cloudalertrulecnqs/:id`

Deletes the CNQ Result of a given policy in an alert rule.

##### `GET /cloudalertrulecnqs/:id`

Retrieves the last run result of a given policy in an alert rule.

Parameters:

- `q` (`string`): Filtering query. Consequent `q` parameters will form an or.

##### `PUT /cloudalertrulecnqs/:id`

Updates the CNQ Result of a given policy in an alert rule.
...
The reply object for a Cloud Network Query from the Graph Calculator.
...
##### `POST /cloudnetworkqueryreplies`

Creates a cloud network query reply for a given cloud network query.
