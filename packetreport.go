...
func (o *PacketReport) GetSpread() int {

	return o.Spread
}

// SetSpread sets the property Spread of the receiver using the given value.
func (o *PacketReport) SetSpread(spread int) {
...
// GetSpread returns the Spread of the receiver.
func (o *SparsePacketReport) GetSpread() (out int) {
...
func (o *SparsePacketReport) SetSpread(spread int) {
