...
func (o *CachedFlowReport) GetSpread() int {

	return o.Spread
}

// SetSpread sets the property Spread of the receiver using the given value.
func (o *CachedFlowReport) SetSpread(spread int) {
...
// GetSpread returns the Spread of the receiver.
func (o *SparseCachedFlowReport) GetSpread() (out int) {
...
func (o *SparseCachedFlowReport) SetSpread(spread int) {
