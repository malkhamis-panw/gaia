...
func (o *Automation) Doc() string {
	...
	return `Allows you to define some JavaScript code and specify the conditions under which it should
be executed.`
}
...
var AutomationAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"AporetoToken": {
		...
		Description: `Contains the Microsegmentation token used by the automation's HTTP client. This token is
derived from the automation's app credential attribute.`,
		Encrypted: true,
		Name:      "aporetoToken",
		Stored:    true,
